...
describe('oxlint', () => {
  describe('runOxlintCheck', () => {
    it('should return a result with passed and output', () => {
      const result = runOxlintCheck('/tmp/nonexistent-test-file.ts')
    ...
    it('should pass for a clean existing file', () => {
      ...
      const result = runOxlintCheck('src/lib/oxlint.ts')
  ...
  describe('runOxlintFix', () => {
    it('should return a result with fixed, remaining, and output', () => {
      const result = runOxlintFix('/tmp/nonexistent-test-file.ts')
  ...
  describe('shouldIgnoreOxlint', () => {
    it('should return a boolean', () => {
      const result = shouldIgnoreOxlint('src/lib/oxlint.ts')
